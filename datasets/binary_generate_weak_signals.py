...
from helper_weak_signals import *
...
def OBS_generator():
    ...
    obs_data = Data("OBS", [1, 2, 20], 'obs/obs_network.data', 'results/json/obs_network.json', obs_load_and_process_data)
    ...
    # print("\n\ntesting variables:")
    # print("\n weak sig: ")
    # print("shape: ",  multiple_weak_signals[2]['probabilities'].T.shape)
    # print("type: ", type(multiple_weak_signals[2]['probabilities'].T))

    # print("\n train_data: ", train_data.T)
    # print("shape: ", train_data.T.shape)
    # print("type: ", type(train_data.T))
